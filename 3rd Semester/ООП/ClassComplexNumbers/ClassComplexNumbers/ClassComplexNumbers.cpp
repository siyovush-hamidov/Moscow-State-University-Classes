...
public: 
	...
	Complex Lg(Complex a)
	{
		...
		Complex lg, lg2, empty;
		empty.Re = log10(Euler);
		empty.Im = 0;
		lg2 = Mult(empty, Ln(a));
...
int main()
{
	...
	cout << "\n=============================\n";
	cout << "ALGEBRAIC TO TRIGONOMETRIC: "; y.ToTrig();
	cout << "=============================\n";
	cout << "ALGEBRAIC TO EXPONENTIAL: "; y.ToExpo();
	cout << "=============================\n";
	cout << "TRIGONOMETRIC TO EXPONENTIAL: "; x.TrigToExpo(y);
	cout << "=============================\n";
	cout << "EXPONENTIAL TO TRIGONOMETRIC: "; x.ExpoToTrig(y);
	cout << "=============================\n";
